...
app.whenReady().then(()=>{require("./ipc/categories.cjs");require("./ipc/products.cjs");require("./ipc/sales.cjs");require("./ipc/orders.cjs");require("./ipc/stock.cjs");require("./ipc/sales-history.cjs");require("./ipc/reports.cjs");require("./ipc/dashboard.cjs");createWindow();app.on("activate",()=>{if(BrowserWindow.getAllWindows().length===0)createWindow();});});
