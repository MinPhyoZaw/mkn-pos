...
app.whenReady().then(()=>{require("./ipc/categories.cjs");require("./ipc/products.cjs");require("./ipc/sales.cjs");createWindow();app.on("activate",()=>{if(BrowserWindow.getAllWindows().length===0)createWindow();});});
